...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMaximumSize(QSize(1260, 680))
        ...
        self.centralwidget.setMinimumSize(QSize(1260, 610))
        self.centralwidget.setMaximumSize(QSize(1260, 610))
        ...
        self.param_frame = QFrame(self.centralwidget)
        self.param_frame.setObjectName(u"param_frame")
        self.param_frame.setGeometry(QRect(1080, 0, 181, 601))
        self.param_frame.setFrameShape(QFrame.Shape.StyledPanel)
        self.param_frame.setFrameShadow(QFrame.Shadow.Raised)
        self.jer_input = QLineEdit(self.param_frame)
        self.jer_input.setObjectName(u"jer_input")
        self.jer_input.setGeometry(QRect(80, 90, 90, 20))
        self.parameters = QLabel(self.param_frame)
        self.parameters.setObjectName(u"parameters")
        self.parameters.setGeometry(QRect(30, 20, 121, 31))
        self.parameters.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.jer_label = QLabel(self.param_frame)
        self.jer_label.setObjectName(u"jer_label")
        self.jer_label.setGeometry(QRect(15, 90, 60, 20))
        self.jer_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.scale_label = QLabel(self.param_frame)
        self.scale_label.setObjectName(u"scale_label")
        self.scale_label.setGeometry(QRect(15, 145, 60, 20))
        self.scale_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.scale_input = QLineEdit(self.param_frame)
        self.scale_input.setObjectName(u"scale_input")
        self.scale_input.setGeometry(QRect(80, 145, 90, 20))
        self.rate_label = QLabel(self.param_frame)
        self.rate_label.setObjectName(u"rate_label")
        self.rate_label.setGeometry(QRect(15, 200, 60, 20))
        self.rate_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.rate_input = QLineEdit(self.param_frame)
        self.rate_input.setObjectName(u"rate_input")
        self.rate_input.setGeometry(QRect(80, 200, 90, 20))
        self.msd_label = QLabel(self.param_frame)
        self.msd_label.setObjectName(u"msd_label")
        self.msd_label.setGeometry(QRect(15, 255, 60, 20))
        self.msd_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.msd_input = QLineEdit(self.param_frame)
        self.msd_input.setObjectName(u"msd_input")
        self.msd_input.setGeometry(QRect(80, 255, 90, 20))
        self.smoothing_label = QLabel(self.param_frame)
        self.smoothing_label.setObjectName(u"smoothing_label")
        self.smoothing_label.setGeometry(QRect(15, 310, 60, 20))
        self.smoothing_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.smoothing_input = QLineEdit(self.param_frame)
        self.smoothing_input.setObjectName(u"smoothing_input")
        self.smoothing_input.setGeometry(QRect(80, 310, 90, 20))
        self.threshold_label = QLabel(self.param_frame)
        self.threshold_label.setObjectName(u"threshold_label")
        self.threshold_label.setGeometry(QRect(15, 365, 60, 20))
        self.threshold_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.threshold_input = QLineEdit(self.param_frame)
        self.threshold_input.setObjectName(u"threshold_input")
        self.threshold_input.setGeometry(QRect(80, 365, 90, 20))
        self.set_button = QPushButton(self.param_frame)
        self.set_button.setObjectName(u"set_button")
        self.set_button.setGeometry(QRect(50, 490, 81, 26))
        self.oer_input = QLineEdit(self.param_frame)
        self.oer_input.setObjectName(u"oer_input")
        self.oer_input.setGeometry(QRect(80, 420, 90, 20))
        self.oer_label = QLabel(self.param_frame)
        self.oer_label.setObjectName(u"oer_label")
        self.oer_label.setGeometry(QRect(15, 420, 60, 20))
        self.oer_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rate_label.setText(QCoreApplication.translate("MainWindow", u"Rate", None))
        ...
        self.set_button.setText(QCoreApplication.translate("MainWindow", u"Set", None))
        self.oer_input.setPlaceholderText(QCoreApplication.translate("MainWindow", u"20", None))
        self.oer_label.setText(QCoreApplication.translate("MainWindow", u"OER", None))
